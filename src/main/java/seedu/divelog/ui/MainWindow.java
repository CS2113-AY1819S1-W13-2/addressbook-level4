...
public class MainWindow extends UiPart<Stage> {
    ...
    private DiveListPanel diveListPanel;
    ...
    @FXML
    private StackPane diveListPanelPlaceholder;
    ...
    void fillInnerParts() {
        ...
        dateTimePlaceHolder.getChildren().add(dateTimeBox.getRoot());

        browserPanel = new BrowserPanel();
        browserPlaceholder.getChildren().add(browserPanel.getRoot());

        diveListPanel = new DiveListPanel(logic.getFilteredDiveList());
        diveListPanelPlaceholder.getChildren().add(diveListPanel.getRoot());
    ...
    public DiveListPanel getDiveListPanel() {
        return diveListPanel;
    }
